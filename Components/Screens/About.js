...
const About =( {navigation, navigation: { goBack } })=>{
    ...
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={()=> navigation.navigate('EditAbout')}>
                <View style={styles.editProfileContainer}>
                    <AntDesign style={styles.editIcon} name={"edit"} size={20}/>
            ...
            <View style={{marginHorizontal: width(4),  borderBottomWidth: 0.5}}>
