  ...
  return (
    <View style={{flex: 1, backgroundColor: '#eeeeee'}}>
        ...
        <View style={Styles.lowerContainer}>
                <TouchableOpacity onPress={()=> navigation.navigate('Verification')} activeOpacity={0.8} style={{flexDirection: 'row', alignItems: 'center', backgroundColor: '#5669FF', borderRadius: 20, justifyContent: 'center', height: height(8)}}>
                ...
                <View style={Styles.lastThrid}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} style={Styles.lastThridView}>
                        <Text style={Styles.txtx}>Company</Text>
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={0.8} style={Styles.lastThirdx} onPress={()=> navigation.navigate('ClientSignUp')}>
                        <Text  style={{color: 'white', fontSize: 16}}>Client</Text>
                    </TouchableOpacity>
