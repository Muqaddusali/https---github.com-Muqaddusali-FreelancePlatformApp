...
export default function ClientSideServices({ navigation, navigation: { goBack } }) {
  ...
  return (
    <View>
        <AntDesign name={"arrowleft"} style={styles.arrow} size={25} onPress={()=> navigation.navigate('ClientHome')}/>
            ...
            <View style={styles.heading}>
                <TouchableOpacity activeOpacity={0.7} onPress={()=> navigation.navigate('ClientSideAbout')}>
                    <Text style={styles.txt}>ABOUT</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.7}>
                    <Text style={[styles.txt, styles.txtx]}>SERVICES</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.7} onPress={()=> navigation.navigate('ClientSideReviews')}>
