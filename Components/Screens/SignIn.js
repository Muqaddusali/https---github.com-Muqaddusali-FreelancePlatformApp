    ...
    return(
        <View style={{height: '100%', backgroundColor: '#eeeeee'}}>
            ...
            <View style={Styles.lowerContainer}>
                <TouchableOpacity onPress={() => navigation.navigate('TabNavigation')} activeOpacity={0.8} style={{flexDirection: 'row', alignItems: 'center', backgroundColor: '#5669FF', borderRadius: 20, justifyContent: 'center', height: height(8)}}>
                ...
                <View style={Styles.lastThrid}>
                    ...
                    <TouchableOpacity
                     activeOpacity={0.8} style={Styles.lastThirdx}
