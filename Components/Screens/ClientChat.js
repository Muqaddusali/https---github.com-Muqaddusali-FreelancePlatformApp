...
const ClientChat = ({ navigation}) => {
    const moveNext = (user, image) => {
        navigation.navigate('ClientSubChat', {
            user: user,
            image: image
        })
    }
  return (
    <View style={styles.Container}>
      ...
      <AntDesign name={"arrowleft"} style={styles.arrow} size={23} onPress={()=> navigation.navigate('Client')}/>
      ...
      <View style={styles.UpperTxtContainer}>
        ...
        <TouchableOpacity activeOpacity={0.6} onPress={()=> navigation.navigate('ClientSideNotification')}>
