...
const ClientProposel = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <View style={{marginHorizontal: '5%', flex: 1}}>
        ...
        <ScrollView scroll>
            <Text style={{color: '#5669FF', fontSize: 18, marginTop: '3%', fontWeight: '400',}}>Briefly describe your needs</Text>
