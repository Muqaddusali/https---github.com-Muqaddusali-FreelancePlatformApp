...
const ClientResetPassword = ({ navigation, navigation: { goBack } }) =>{
    return(
        <View style={{flex: 1, backgroundColor: '#eeeeee'}}>
            ...
            <View style={style.container}>
                ...
                <TouchableOpacity activeOpacity={0.8} style={style.btn} onPress={()=> navigation.navigate('ClientVerification')}>
